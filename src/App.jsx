...
const INIT_STATE = {
  plan: { mode: 'ebook', topic: '', topicSeed: '', format: '쇼츠 60초', targets: ['부모'], ebookName: '', ebookSummary: '', ebookUrl: '', tone: '따뜻한', model: 'claude-opus-4-6', characterImage: '', characterDescription: '', characterColorLock: '' },
